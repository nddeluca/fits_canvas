...
(function() {
  ...
  FitsDisplay = (function(_super) {
    ...
    FitsDisplay.prototype.processImage = function() {
      var orig_index, orig_x, orig_y, x, y, _i, _ref, _results;
      ...
      for (x = _i = 0, _ref = this.width - 1; 0 <= _ref ? _i <= _ref : _i >= _ref; x = 0 <= _ref ? ++_i : --_i) {
        _results.push((function() {
          ...
          for (y = _j = 0, _ref1 = this.height - 1; 0 <= _ref1 ? _j <= _ref1 : _j >= _ref1; y = 0 <= _ref1 ? ++_j : --_j) {
            orig_x = ~~(x * this.scaleRatio);
            orig_y = ~~(y * this.scaleRatio);
            orig_index = ((this.fitsHeight - 1) - orig_y) * this.fitsWidth + orig_x;
            _results1.push(this.displayView32[(this.width * y) + x] = this.colorView32[orig_index]);
          }
          return _results1;
        }).call(this));
      }
