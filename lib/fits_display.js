...
(function() {
  ...
  FitsDisplay = (function(_super) {
    ...
    function FitsDisplay() {
      return FitsDisplay.__super__.constructor.apply(this, arguments);
    }

    FitsDisplay.prototype.contructor = function(container, color, scale, desiredWidth, fitsFile) {
      ...
      return FitsDisplay.__super__.contructor.call(this, container, scaledWidth, scaledHeight);
    };
    ...
    FitsDisplay.prototype.buildColorBuffer = function() {
      this.colorBuffer = new ArrayBuffer(this.fitsWidth * this.fitsHeight * 4);
      this.colorView8 = new Uint8ClampledArray(this.colorBuffer);
